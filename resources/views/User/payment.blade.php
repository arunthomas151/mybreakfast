...
<body>
    ...
    <div class="swiper-container swiper-slider swiper-white" data-loop="false" data-autoplay="false"
        ...
        <a class="button button-icon button-primary book-rooms" href="#" data-toggle="modal"
                        data-target="#payment" data-roomid="" data-did="">
                            <span>Payment</span><span class="icon material-icons-chevron_right"></span>
                        </a>
                                    ...
                                    <div class="w3_agileits_card_number_grids">
                                        ...
                                        <div class="w3_agileits_card_number_grid_right">
                                            <div class="controls">
                                                ...
                                                <input class="security-code form-control" Â·inputmode="numeric" type="text" name="ccv" placeholder="&#149;&#149;&#149;" required="">
                                            </div>
                                        </div>
                                        <div class="clear"> </div>
                                    </div>

    ...
    <section class="section-sm row bg-white row">
        <div class="text-center">
            ...
            <table>
                    ...
                    <tr>
                            <td></td>
                            <td>{{ $vpay[0]->vcidate}}</td>
                            <td>{{ $vpay[0]->vcodate}}</td>
                            <td>{{ $vpay[0]->vnop }}</td>
                            <td>{{ $vpay[0]->vamount }}</td>
                            <td>
                                <?php 
                                $total = $total + $vpay[0]->vamount;
                                ?>
                            </td>
                    </tr>
                    <tr>
                        ...
                        <tr>
                            ...
                            data-target="#payment" data-roid="{{ $pay[0]->rbid }}" data-void="{{ $vpay[0]->vbid }}"><span>Make Payement</span><span class="icon material-icons-chevron_right"></span>
                                </a></td>
                        </tr>
                        @else
                        <tr>
                            ...
                            <tr>
                                <td colspan="6"><a class="button button-icon button-primary payment2" href="#" data-toggle="modal"
                                data-target="#payment" data-roid="{{ $pay[0]->rbid }}"><span>Make Payement</span><span class="icon material-icons-chevron_right"></span>
                                    </a></td>
                            </tr>
                    @endif
            ...
            <ul>
                <li>
                    ...
                    <div class="nl-content">
                        ...
                        <form action="/upayment" method="post" class="creditly-card-form agileinfo_form">
                            @csrf
                            <input type="hidden" name="roomid" id="roomid">
                            <input type="hidden" name="vehiid" id="vehiid">
...
<script>
    $(".payment2").on("click", function () {
        $roomid = $(this).data("roid");
        $("#roomid").val($roomid);
        $vehid = $(this).data("void");
        $("#vehiid").val($vehid);
    });
    </script>

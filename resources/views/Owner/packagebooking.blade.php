            ...
            <div class="container-fluid"><br>
                <div class="text-center">
                        ...
                        <table>
                            ...
                            <td><a class="button button-icon button-primary book-details"
                                    href="/vbookingowner"><span>Booked Vehicles</span><span
                                        class="icon material-icons-chevron_right"></span></a></td>
                            <td><a class="button button-icon button-primary book-details"
                                    href="pbookingowner"><span>Booked Packages</span><span
                                        class="icon material-icons-chevron_right"></span></a></td>
                        </table><br>
                        <?php $a=1; ?>
                        @if (!$rbooking->count())
                        ...
                        <div class="row">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td>{{ $a }}</td>
                                        <td>{{ $rbookings->pkname}}</td>
                                        <td>{{ $rbookings->u_name}}</td>
                                        <td>{{ $rbookings->bfname }}</td>
                                        <td>{{ $rbookings->vrno}}</td>
                                        <td>{{ $rbookings->pbdate}}</td>
                                        <td>{{ $rbookings->pnop }}</td>
                                        <td>{{ $rbookings->u_mob }}</td>
                                        <?php $a=$a+1; ?>
                                        @endforeach
                                </table>
                            </div>
                    ...
                    <div class="box">
                        <div class="content">
                            <div class="form loginBox">
                                ...
                                <form method="post" action="/pbookingsearch" accept-charset="UTF-8"

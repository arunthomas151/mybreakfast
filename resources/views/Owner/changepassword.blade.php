            ...
            <div class="container-fluid">
                ...
                <div class="profile">
                    <div class="swiper-container swiper-slider swiper-white" data-loop="false" data-autoplay="false"
                        ...
                        <form method="post" action="/savepassword" accept-charset="UTF-8">
                            @csrf
                            ...
                            <br>
                            <input id="password1" class="form-control" type="password" placeholder=" Enter New Password"
                                name="password" required  onchange="Validatepassword1();">

                ...
                <div class="text-center">
                        ...
                        <div class="profile" align:="center">
                            <div class="swiper-container swiper-slider swiper-white" data-loop="false"
                                ...
                                <form method="post" action="/saveprofile" accept-charset="UTF-8"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <input type="text" class="form-control" placeholder="Enter Your Address"
                                        name="address" id="address" required onchange="Validateaddress()" ;>
                                    ...
                                    <br>
                                    <input type="text" class="form-control" placeholder="Enter Your Adhar Number"
                                        name="idno" id="idno" required onchange="Validateid()" ;>

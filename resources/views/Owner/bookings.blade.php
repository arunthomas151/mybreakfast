    ...
    <div class="page-wrapper">
        ...
        <section>
            <div class="container-fluid"><br>
                ...
                @else
                <div class="text-center">
                    <h5>Recent Bookings</h5><br>
                </div>
                <table>
                    <td><a class="button button-icon button-primary" href="/bookings"><span>Booked Rooms</span><span
                ...
                <div class="box">
                    <div class="content">
                        <div class="form loginBox">
                            ...
                            <form method="post" action="/bookingsearch" accept-charset="UTF-8"

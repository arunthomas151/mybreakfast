                    ...
                    <div class="col-md-12">
                        <div class="profile" align:="center">
                            ...
                            <div class="swiper-container swiper-slider swiper-white" data-loop="false"
                                ...
                                <form method="post" action="/vehicleadd" accept-charset="UTF-8"
                                    ...
                                    <br>
                                    <input type="text" class="form-control" placeholder="Enter Vehicle Owner Name"
                                        name="voname" id="voname" required onchange="Validatevoname()" ;>
                                    ...
                                    <input type="file" class="form-control" id="pic" accept=".png, .jpg, .jpeg,.JPG"
                                        name="pic" required onchange="Validateimage();">
                                    ...
                                    <br>
                                    <input type="text" class="form-control" placeholder="Enter Seating Capacity"
                                        name="nofseat" id="nofseat" required onchange="Validateamnt();">
                                    ...
                                    <br>
                                    <input type="text" class="form-control" placeholder="Enter Minumum Kilometer"
                                        name="klmtr" id="klmtr" required onchange="Validatekm();">
                                    ...
                                    <br>
                                    <input type="text" class="form-control" placeholder="Enter Your Vehicle Rent"
                                        name="vrmnt" id="vrmnt" required onchange="Validateamnt()" ;>
